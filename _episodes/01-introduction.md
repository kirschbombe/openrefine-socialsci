...
- "Why use OpenRefine?"
objectives:
- "Understand OpenRefine’s uses and applications."
- "Differentiate data cleaning from data organization."
- "Become familiar with OpenRefine’s user interface."
- "Learn about helpful resources for OpenRefine."
keypoints:
...
* Data is often very messy. OpenRefine provides a set of tools to allow you to explore and clean up your messy data.
...
* OpenRefine saves your work to a new file -- it always uses a copy of your data and _does not_ modify your original dataset.
* Data cleaning steps often need to be repeated with multiple files. OpenRefine keeps track of all of your actions and allows them to be applied to different datasets.
